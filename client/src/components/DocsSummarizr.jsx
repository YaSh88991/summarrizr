...
export default function DocsSummarizr({ summaryRef, triggerScroll }) {
  ...
  const handleSummarize = () =>
    handleSummarizeAPI({
      endPoint: "http://localhost:5000/api/summarize/docs",
      payload: { text },
      setSummary,
      setError,
      setLoading,
